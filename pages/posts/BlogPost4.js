        ...
        <div>
            ...
            <section class="mx-auto max-w-6xl py-3 sm:py-48 lg:py-20">
                ...
                <div class="p-8 flex flex-col gap-4 sm:flex-col md:flex-row">
                    ...
                    {/* <!-- Post BlogPost --> */}
                    <div class="p-4 rounded max-w-fit md:max-w-fit">
                        <div>
                ...
                <p class="px-8 py-3">
                    <h1 className="text-xl">Model-View-Controller (MVC)</h1>
                    <div class="flex flex-col">
                        <p>
                            <span className="font-bold">MODEL:</span> represents the data.
                        </p><p>
                            <span className="font-bold">VIEW:</span> represents the layout or the way data is being displayed to the user {`(viewer)`}
                        </p><p>
                ...
                <p class="px-8 py-3">
                    For example, I have a set of data on Students. Each Student has a name and an assigned class. So that data set would consist of an userId, name, and class. All of this can be defined in our Model as our data set or scheme. The model is a student database. Now, if I am building an app, I would create a user interface {`(UI)`} to access that data and display it on the screen. So maybe there are 3 students in that class and I want to see all three students and then maybe update one of their courses. The UI would be our View.
                </p>
                ...
                <p class="px-8 py-3">
                    ...
                    <div class="flex flex-col">
                        <p>
                            <span className="font-bold">CREATE:</span> post - access the model via a controller
                        </p><p>
                            <span className="font-bold">READ:</span> get - controller brings the data into View
                        </p><p>
                            <span className="font-bold">UPDATE:</span> put/patch - access the model via the controller to update the data
                        </p><p>

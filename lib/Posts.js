...
export const posts = () => {
    return (
        ...
        //     <section class="mx-20">
        //         <h1 class="mt-10 text-3xl">Post Page Details</h1>
        ...
        //                                 <img src="https://randomuser.me/api/portraits/women/47.jpg" alt="Photo of Jayne Dough" class="w-12 h-12 rounded-full">
        //                                     <div class="flex flex-col">
        //                                         <h3 class="text-slate-900 font-bold">@letasilva</h3>
        //                                         <p class="text-slate-700 text-sm dark:text-slate-400">Lorem ipsum dolor, sit amet consectetur adipisicing.</p>
        //                                     </div>
        //                             </div>

        //                             <div class="flex items-center gap-4 p-4">
        //                                 <img src="https://randomuser.me/api/portraits/women/75.jpg" alt="Photo of Jayne Dough" class="w-12 h-12 rounded-full">
        //                                     <div class="flex flex-col">
        //                                         <h3 class="text-slate-900 font-bold">@tracyperry</h3>
        //                                         <p class="text-slate-700 text-sm dark:text-slate-400">Lorem ipsum dolor sit amet consectetur, adipisicing elit dignissimos.</p>
        //                                     </div>
        //                             </div>

        //                             <div class="flex items-center gap-4 p-4">
        //                                 <img src="https://randomuser.me/api/portraits/men/85.jpg" alt="Photo of Jayne Dough" class="w-12 h-12 rounded-full">
        //                                     <div class="flex flex-col">
        //                                         <h3 class="text-slate-900 font-bold">@dennisholland</h3>
        //                                         <p class="text-slate-700 text-sm dark:text-slate-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus, fuga.</p>
        //                                     </div>
        //                             </div>
        ...
        //                                 <div class="flex flex-col">
        //                                     <h3 class="text-slate-900 font-bold">Jayne Dough</h3>
        //                                     <p class="text-slate-500 text-sm font-medium dark:text-slate-400">@jaynedough - This information will be displayed publicly so be careful what you share.</p>

        //                                     <div class="flex items-center gap-4 p-4">
        //                                         <img src="https://randomuser.me/api/portraits/men/22.jpg" alt="Photo of Jon Ford" class="w-12 h-12 rounded-full">
        //                                             <div class="flex flex-col">
        //                                                 <h3 class="text-slate-900 font-bold">@jonford</h3>
        //                                                 <p class="text-slate-700 text-sm dark:text-slate-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci et perspiciatis nemo?</p>
        //                                             </div>
        //                                     </div>
        //                                 </div>
        //                             </div>
        ...
        //                                                     <input type="text" name="name" id="name" autocomplete="name" class="mt-1 focus:ring-green-500 focus:border-green-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
        ...
        //                                         <div>
        //                                             <label for="about" class="block text-sm font-medium text-gray-700"> Comment </label>
        //                                             <div class="mt-1">
        //                                                 <textarea id="about" name="about" rows="3" class="shadow-sm focus:ring-green-500 focus:border-green-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="Enter Your Comment Here"></textarea>
        //                                             </div>
        ...
        //                                                     </svg>
        //                                                 </span>
        //                                                 <button type="button" class="ml-5 bg-white py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">Change</button>
        //                                             </div>
        //                                         </div>
